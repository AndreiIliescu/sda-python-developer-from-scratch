...
Permite adaugarea de noi operatii asupra unui set de obiecte fara a modifica structura originala.
Pastreaza clasele nemodificate. """
...
class XHTMLFile(HTMLFile):
    ...
    def get_doctype_declaration(self):
        return '<?xml version="1.0" encoding="UTF-8"?>' '<!DOCTYPE html' 'PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"' '"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">' '<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">'
...
def main():
    ...
    html4_file = HTML4File('<head> <title>Title</title> </head>', '<body> <p>HTML4 FILE</p> </body>', visitor)
    html5_file = HTML5File('<head> <meta charset="UTF-8"> <title>Title</title> </head>', '<body> <p>HTML5 FILE</p> </body>', visitor)
    xhtml_file = XHTMLFile('<head> <title>Title</title> </head>', '<body> <p>XHTML file</p></body>', visitor)
